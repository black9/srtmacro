...
if (document.URL.substring(0, dsturl1.length) == dsturl1) {
	...
	$(document).ready(function() {
		...
		if (sessionStorage.getItem('macro') == "true") {
			$("div#search_top_tag.tal_c.mgt30").append('<a href="#" onclick="macrostop();" style="margin-left:5px;"><img src="' + chrome.extension.getURL('images/btn_stop.png') + '"></a>');
		} else {
			$("div#search_top_tag.tal_c.mgt30").append('<a href="#" onclick="macro();" style="margin-left:5px;"><img src="' + chrome.extension.getURL('images/btn_start.png') + '"></a>');
		}
